...
static const u8 sText_KantoStarter[] = _("KANTO");
static const u8 sText_JohtoStarter[] = _("JOHTO");
static const u8 sText_HoennStarter[] = _("HOENN");
static const u8 sText_SinnohStarter[] = _("SINNOH");
static const u8 sText_UnovaStarter[] = _("UNOVA");
static const u8 sText_KalosStarter[] = _("KALOS");
static const u8 sText_AlolaStarter[] = _("ALOLA");
static const u8 sText_GalarStarter[] = _("GALAR");

// Sets of multichoices.
static const struct ListMenuItem sSet1[] =
{
    {sText_KantoStarter, 0},
    {sText_JohtoStarter, 1},
    {sText_HoennStarter, 2},
    {sText_SinnohStarter, 3},
    {sText_UnovaStarter, 4},
    {sText_KalosStarter, 5},
    {sText_AlolaStarter, 6},
