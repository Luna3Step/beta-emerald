...
static const struct TrainerMon sParty_Verna[] = {
    {
    .iv = 90,
    .lvl = 71,
...
static const struct TrainerMon sParty_Chas[] = {
    {
    .iv = 40,
    .lvl = 68,
...
static const struct TrainerMon sParty_Danial[] = {
    {
    .iv = 40,
    .lvl = 70,
...
static const struct TrainerMon sParty_Lucien[] = {
    {
    .iv = 140,
    .lvl = 70,
...
static const struct TrainerMon sParty_Booker[] = {
    {
    .iv = 140,
    .lvl = 70,
    .species = SPECIES_NINETALES,
...
static const struct TrainerMon sParty_Kasey[] = {
    {
    .iv = 40,
    .lvl = 71,
...
static const struct TrainerMon sParty_Rene[] = {
    {
    .iv = 40,
    .lvl = 75,
...
static const struct TrainerMon sParty_Mona[] = {
    {
    .iv = 0,
    .lvl = 78,
...
static const struct TrainerMon sParty_Brant[] = {
    {
    .iv = 40,
    .lvl = 73,
...
static const struct TrainerMon sParty_Luann[] = {
    {
    .iv = 140,
    .lvl = 72,
...
static const struct TrainerMon sParty_Eugenia[] = {
    {
    .iv = 40,
    .lvl = 77,
...
static const struct TrainerMon sParty_Ray[] = {
    {
    .iv = 40,
    .lvl = 75,
...
static const struct TrainerMon sParty_Glenna[] = {
    {
    .iv = 40,
    .lvl = 77,
...
static const struct TrainerMon sParty_Tricia[] = {
    {
    .iv = 40,
    .lvl = 77,
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .moves = {MOVE_THUNDER, MOVE_FACADE, MOVE_SUPERPOWER, MOVE_VOLT_SWITCH},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_JOLLY
    },
    {
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_SHADOW_CLAW, MOVE_GUNK_SHOT, MOVE_WILL_O_WISP, MOVE_SUCKER_PUNCH},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_X_SCISSOR, MOVE_SHADOW_SNEAK, MOVE_PROTECT},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_LONELY
    },
    {
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .moves = {MOVE_BLIZZARD, MOVE_FREEZE_DRY, MOVE_EARTHQUAKE, MOVE_HIDDEN_POWER},
    .ability = ABILITY_HIDDEN,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_AVALANCHE, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_MIRROR_COAT},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_ADAMANT
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_SPARK, MOVE_ROLLOUT, MOVE_PROTECT, MOVE_STEALTH_ROCK},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .moves = {MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_HOWL, MOVE_ROCK_TOMB},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_ROLLOUT, MOVE_ROCK_THROW},
    .ability = ABILITY_SLOT_1,
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_SEISMIC_TOSS, MOVE_KNOCK_OFF, MOVE_ROCK_TOMB, MOVE_HEAVY_SLAM},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_AGILITY, MOVE_MIND_READER, MOVE_HIGH_JUMP_KICK, MOVE_IRON_TAIL},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_ROCK_SMASH, MOVE_BUBBLE_BEAM, MOVE_EARTHQUAKE, MOVE_ROCK_TOMB},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .species = SPECIES_MAKUHITA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BULK_UP, MOVE_DYNAMIC_PUNCH, MOVE_KNOCK_OFF, MOVE_BULLET_PUNCH},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    }
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .species = SPECIES_VOLTORB,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_CHARGE_BEAM, MOVE_ROLLOUT},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .species = SPECIES_ELECTRIKE,
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_ELECTRO_BALL, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_SWITCHEROO},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_TIMID
    },
    {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_GIGA_DRAIN, MOVE_BUG_BITE},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_TIMID
    },
    {
    ...
    .species = SPECIES_MAGNEMITE,
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_SPARK, MOVE_MAGNET_BOMB, MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_TIMID
    },
    {
    ...
    .heldItem = ITEM_HEAVY_DUTY_BOOTS,
    .moves = {MOVE_THUNDERBOLT, MOVE_ELECTRO_BALL, MOVE_PSYCHIC, MOVE_TOXIC},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_TIMID
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .species = SPECIES_NUMEL,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_LAVA_PLUME, MOVE_FIRE_BLAST, MOVE_EARTHQUAKE, MOVE_GROWTH},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_MODEST
    },
    {
    ...
    .species = SPECIES_SLUGMA,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_FLAMETHROWER, MOVE_CLEAR_SMOG, MOVE_MEMENTO, MOVE_TOXIC},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_BOLD
    },
    {
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_FIRE_BLAST, MOVE_BITE, MOVE_HIDDEN_POWER, MOVE_OVERHEAT},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_TIMID
    },
    {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_RAPID_SPIN, MOVE_ROCK_TOMB, MOVE_STEALTH_ROCK, MOVE_FIRE_BLAST},
    .ability = ABILITY_SLOT_2,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_IMPRISON, MOVE_TRICK_ROOM, MOVE_WILL_O_WISP, MOVE_FIRE_BLAST},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_QUIET
    },
    {
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DEFENSE_CURL, MOVE_DOUBLE_KICK, MOVE_REST, MOVE_FACADE},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_IMPISH
    },
    {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_RECOVER, MOVE_ICE_BEAM, MOVE_THIEF, MOVE_TOXIC},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_BOLD
    },
    {
    ...
    .moves = {MOVE_DOUBLE_TEAM, MOVE_EXTREME_SPEED, MOVE_COVET, MOVE_WATER_PULSE},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .heldItem = ITEM_CHOICE_SPECS,
    .moves = {MOVE_PARABOLIC_CHARGE, MOVE_HYPER_VOICE, MOVE_THUNDERBOLT, MOVE_SURF},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_TIMID
    },
    {
    ...
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_FAKE_OUT, MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_BITE},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_ADAMANT
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .moves = {MOVE_ACROBATICS, MOVE_SWORDS_DANCE, MOVE_FLYING_PRESS, MOVE_ROOST},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LEECH_SEED, MOVE_SUBSTITUTE, MOVE_AERIAL_ACE, MOVE_TOXIC},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_BOLD
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_FACADE, MOVE_EARTHQUAKE, MOVE_ROOST},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_ADAMANT
    }
};
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_WISH, MOVE_PROTECT, MOVE_KNOCK_OFF, MOVE_SCALD},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_BOLD
    },
    {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ROAR, MOVE_TOXIC, MOVE_ICE_BEAM, MOVE_SUPER_FANG},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_CALM
    },
    {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_SWORDS_DANCE, MOVE_RAZOR_SHELL, MOVE_KNOCK_OFF, MOVE_AQUA_JET},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_PSYCHIC_FANGS, MOVE_PROTECT},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    },
    {
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_SUBSTITUTE},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SCALD, MOVE_RECOVER, MOVE_ICE_BEAM, MOVE_TOXIC},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_CALM
    }
};
...
static const struct TrainerMon sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_ANCIENT_POWER, MOVE_WING_ATTACK, MOVE_TAILWIND, MOVE_TAUNT},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_THUNDERBOLT, MOVE_EARTHQUAKE, MOVE_FIRE_BLAST, MOVE_ROCK_BLAST},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    },
    {
    .iv = 255,
    .lvl = 35,
    .evs = LYCANROC_DUSK_EV,
    .species = SPECIES_LYCANROC_DUSK,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_ROCK_SLIDE, MOVE_IRON_TAIL, MOVE_FIRE_FANG, MOVE_BRICK_BREAK},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_TOXIC, MOVE_EARTHQUAKE, MOVE_ROCK_BLAST, MOVE_DOUBLE_TEAM},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STEALTH_ROCK, MOVE_IRON_TAIL, MOVE_EARTHQUAKE, MOVE_TOXIC},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_CAREFUL
    },
    {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FLASH_CANNON, MOVE_EARTH_POWER, MOVE_THUNDER, MOVE_SANDSTORM},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_MODEST
    }
};
...
static const struct TrainerMon sParty_Roxanne3[] = {
    {
    .iv = 255,
    .evs = AERODACTYL_MEGA_EV,
    .lvl = 37,
    .species = SPECIES_AERODACTYL_MEGA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_WING_ATTACK, MOVE_HYPER_BEAM, MOVE_CRUNCH},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_TAKE_DOWN, MOVE_EARTHQUAKE, MOVE_ROCK_BLAST, MOVE_DOUBLE_TEAM},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .species = SPECIES_PROBOPASS,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FLASH_CANNON, MOVE_EARTH_POWER, MOVE_STONE_EDGE, MOVE_SANDSTORM},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_MODEST
    }
};
...
static const struct TrainerMon sParty_Brawly2[] = {
    ...
    .species = SPECIES_MACHOKE,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_ROLLING_KICK, MOVE_KNOCK_OFF, MOVE_REST, MOVE_SLEEP_TALK},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_IMPISH
    },
    {
    .iv = 255,
    .evs = BRAWLY_LUCARIO_EV,
    .lvl = 33,
    .species = SPECIES_LUCARIO_MEGA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_METEOR_MASH, MOVE_ROCK_TOMB, MOVE_SWORDS_DANCE},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_COMET_PUNCH, MOVE_MACH_PUNCH, MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .moves = {MOVE_SPORE, MOVE_LEECH_SEED, MOVE_FORCE_PALM, MOVE_SLUDGE_BOMB},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_TIMID
    },
    {
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_ICE_PUNCH, MOVE_EARTHQUAKE, MOVE_REVERSAL},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SEISMIC_TOSS, MOVE_KNOCK_OFF, MOVE_FAKE_OUT, MOVE_ROCK_TOMB},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_ADAMANT
    }
};
...
static const struct TrainerMon sParty_Brawly3[] = {
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_TOXIC_ORB,
    .moves = {MOVE_SPORE, MOVE_LEECH_SEED, MOVE_FORCE_PALM, MOVE_SKY_UPPERCUT},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_TIMID
    },
    {
...
static const struct TrainerMon sParty_Wattson2[] = {
    ...
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_TAUNT, MOVE_ROLLOUT},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_JOLLY
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROAR, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_HIDDEN_POWER},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_TIMID
    },
    {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_STICKY_WEB, MOVE_THUNDER, MOVE_SIGNAL_BEAM, MOVE_ELECTRO_BALL},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_TIMID
    },
    {
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER, MOVE_FLASH_CANNON, MOVE_ELECTRO_BALL},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_TIMID
    },
    {
    ...
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_THUNDERBOLT, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH},
    .ability = ABILITY_HIDDEN,
    .nature = NATURE_NAIVE
    }
};
...
static const struct TrainerMon sParty_Flannery2[] = {
    {
    .iv = 255,
    .evs = CAMERUPT_MEGA_EV,
    .lvl = 38,
    .species = SPECIES_CAMERUPT_MEGA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_BLAST, MOVE_EARTH_POWER, MOVE_REST, MOVE_YAWN},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_CALM
    },
    {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SUNNY_DAY, MOVE_RECOVER, MOVE_YAWN, MOVE_LAVA_PLUME},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_CALM
    },
    {
    ...
    .heldItem = ITEM_HEAVY_DUTY_BOOTS,
    .moves = {MOVE_STEALTH_ROCK, MOVE_ROCK_TOMB, MOVE_FLAMETHROWER, MOVE_RAPID_SPIN},
    .ability = ABILITY_SLOT_2,
    .nature = NATURE_SASSY
    },
    {
...
static const struct TrainerMon sParty_Norman2[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_GIGA_IMPACT, MOVE_ICE_PUNCH, MOVE_HAMMER_ARM, MOVE_EARTHQUAKE},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_ADAMANT
    },
    {
    ...
    {
    .iv = 255,
    .evs = KANGHASKAN_MEGA_EV,
    .lvl = 45,
    .species = SPECIES_KANGASKHAN_MEGA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKE_OUT, MOVE_SEISMIC_TOSS, MOVE_SHADOW_CLAW, MOVE_ROCK_TOMB},
    .ability = ABILITY_SLOT_1,
    .nature = NATURE_JOLLY
    }
};
...
static const struct TrainerMon sParty_Kelli[] = {
    {
    .iv = 40,
    .lvl = 65,
...
static const struct TrainerMon sParty_Malcom[] = {
    {
    .iv = 40,
    .lvl = 73,
...
static const struct TrainerMon sParty_Lora[] = {
    {
    .iv = 140,
    .lvl = 66,
    .species = SPECIES_MAWILE,
...
static const struct TrainerMon sParty_Marylou[] = {
    {
    .iv = 40,
    .lvl = 72,
...
static const struct TrainerMon sParty_RocketTerrell[] = {
    {
    .iv = 40,
    .lvl = 58,
    .species = SPECIES_GOLEM,
...
static const struct TrainerMon sParty_RocketLil[] = {
    {
    .iv = 40,
    .lvl = 60,
...
static const struct TrainerMon sParty_RocketBill[] = {
    {
    .iv = 40,
    .lvl = 60,
    .species = SPECIES_CARVANHA,
...
static const struct TrainerMon sParty_MauvilleStartersF[] = {
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_LOMBRE,
...
static const struct TrainerMon sParty_MauvilleStartersM[] = {
    {
    .iv = 50,
    .lvl = 22,
    .species = SPECIES_LOMBRE,
...
static const struct TrainerMon sParty_DewfordStarterTrainer[] = {
  {
    .iv = 0,
    .lvl = 19,
...
static const struct TrainerMon sParty_RustboroStarterTrainer[] = {
    {
    .iv = 0,
    .lvl = 15,
...
static const struct TrainerMon sParty_LavaridgeStarterTrainer[] = {
    {
    .iv = 0,
    .lvl = 29,
...
static const struct TrainerMon sParty_PetalburgStarterTrainer[] = {
    {
    .iv = 0,
    .lvl = 31,
...
static const struct TrainerMon sParty_FortreeStarterTrainer[] = {
    {
    .iv = 0,
    .lvl = 33,
...
static const struct TrainerMon sParty_MossdeepStarterTrainer[] = {
    {
    .iv = 0,
    .lvl = 42,
...
static const struct TrainerMon sParty_SootopolisStarterTrainer[] = {
    {
    .iv = 0,
    .lvl = 46,
