...
#define MAP_MEWS_RECLUSE        (57 | (0 << 8))
...
#define MAP_NEW_BIRCH_LAB                        (5 | (1 << 8))
#define MAP_LITTLEROOT_TOWN_DEVELOPER_GYM        (6 | (1 << 8))
...
#define MAP_MEWS_DUNGEON                             (108 | (24 << 8))
...
#define MAP_RUSTURF_UPPER_CAVERN                     (124 | (24 << 8))
